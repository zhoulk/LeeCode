...
public class Test00811 : MonoBehaviour
{
    // Start is called before the first frame update
    void Start()
    {
        IList<string> strs = SubdomainVisits(new string[] { "9001 discuss.leetcode.com" });
    ...
    public IList<string> SubdomainVisits(string[] cpdomains)
    {
        ...
        foreach (var w in cpdomains)
        {
            string[] strs = w.Split(new char[] { ' ' });
            int num = int.Parse(strs[0]);
            string[] partArr = strs[1].Split(new char[] { '.' });
            string url = "";
