...
public class Test00806 : MonoBehaviour
{
    // Start is called before the first frame update
    void Start()
    {
        int[] nums = NumberOfLines(new int[] { 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10 }, "abcdefghijklmnopqrstuvwxyz");
