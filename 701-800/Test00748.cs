...
public class Test00748 : MonoBehaviour
{
    // Start is called before the first frame update
    void Start()
    {
        Debug.Log(ShortestCompletingWord("1s3 PSt", new string[] { "step", "steps", "stripe", "stepple" }));
    }
